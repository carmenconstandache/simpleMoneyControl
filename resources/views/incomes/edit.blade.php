...
@csrf
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="note" name="note" value="{{$income->note}}" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control" id="added_on" name="added_on" value="{{$income->added_on}}">
  </div>
